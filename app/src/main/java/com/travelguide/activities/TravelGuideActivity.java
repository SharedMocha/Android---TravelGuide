...
public class TravelGuideActivity extends AppCompatActivity implements
    ...
    public void showScanner(String mSelectedDayObjectId){
    ...
    public void destVideo(){
        try {
            FragmentManager fm = getSupportFragmentManager();
            OnClickCloudTrackingActivity fragment = (OnClickCloudTrackingActivity) fm
                    .findFragmentById(R.id.fragment_frame_scanner);
            fragment.destvideo();
        } catch (Exception e) {
            e.printStackTrace();
        }
